...
public class ContactController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<CreateContactDTO> findByUserAndId(@RequestHeader("Authorization") String authorizationHeader, @PathVariable Long id) {
        var contact = contactService.findByUserAndId(authorizationHeader, id);
